...
/**
 * Nice static helpers for working with Strings. Maybe not always the fastest solution to call in
 * here, but working. Also usabel for seeing examples and cutting code for manual inlining.
 * 
...
public class StringUtil {
  ...
  /**
   * Appends the given amount of spaces to the String. Keep the param on the calling side. It's
   * reference is modified. Not ment for big append -operations because in a loop alway just one
   * space is added.
   * 
   * @param s
   * @param count
   ...
   * replace them by their toString() - representation. What is special? <br>
   ...
   * contain Arrays do not use this method to avoid overhead.<br>
