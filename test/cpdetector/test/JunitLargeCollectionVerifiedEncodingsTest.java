 ...
 *
 */
public class JunitLargeCollectionVerifiedEncodingsTest extends TestCase{
  /**
  ...
  public JunitLargeCollectionVerifiedEncodingsTest(String methodName)throws Exception {
    super(methodName);
  ...
  public void parseArgs() throws Exception {
    ...
    if (extensionsOption != null) {
      this.extensionFilter = new FileFilterExtensions(new String[]{"verify"});
    } else {
      // Anonymous dummy:
  ...
  public static Test suite(){
    ...
    try{
      final JunitLargeCollectionVerifiedEncodingsTest testbase = new JunitLargeCollectionVerifiedEncodingsTest("process");
  ...
  private static void fillTestCases(JunitLargeCollectionVerifiedEncodingsTest testbase, List testlist,File f){
  ...
  public static void main(String[] args) throws Exception{
      try {
        JunitLargeCollectionVerifiedEncodingsTest detector = new JunitLargeCollectionVerifiedEncodingsTest("process");
        detector.process();
      } catch (Exception e) {
        fail(e.getMessage());
        System.err.println(e.getMessage());
